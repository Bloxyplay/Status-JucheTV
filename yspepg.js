// pages/api/yspepg/program/[...slug].js
// URL: /api/yspepg/program/900001801/20260626
// Matches CCTV style exactly
...
export default async function handler(req, res) {
  ...
  // slug = ['900001801', '20260626']
  if (!slug || slug.length !== 2) {
    return res.status(400).json({ error: "Use /api/yspepg/program/900001801/YYYYMMDD" });
  }

  const [channel, date] = slug;

  // KCTV = 900001801 (matches CCTV style: 600001801)
  if (channel !== "900001801") {
